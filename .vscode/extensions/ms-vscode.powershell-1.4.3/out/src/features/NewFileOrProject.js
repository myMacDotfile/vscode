...
(function (GetProjectTemplatesRequest) {
    GetProjectTemplatesRequest.type = new vscode_languageclient_1.RequestType('powerShell/getProjectTemplates');
...
(function (NewProjectFromTemplateRequest) {
    NewProjectFromTemplateRequest.type = new vscode_languageclient_1.RequestType('powerShell/newProjectFromTemplate');
