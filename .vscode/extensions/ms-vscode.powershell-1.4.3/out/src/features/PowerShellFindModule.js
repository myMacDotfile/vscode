...
(function (FindModuleRequest) {
    FindModuleRequest.type = new vscode_languageclient_1.RequestType('powerShell/findModule');
...
(function (InstallModuleRequest) {
    InstallModuleRequest.type = new vscode_languageclient_1.RequestType('powerShell/installModule');
